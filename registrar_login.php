<?php
    ...
    if(isset($_POST['loginButtonRegistrar'])){
        ...
        if($wasSuccessful == true){
            ...
            // echo "success";
            header("Location: admin/registrar_index.php");
        }
    };
        ...
        <div class="signInContainer">
            <div class="column">
                <div class="header">
                    ...
                    <h3 class="text-center text-muted">Registrar</h3>
                ...
                <div class="loginForm">
                    <form action="registrar_login.php" method="POST">
                        ...
                        <input  type="text" value="registrar" value="<?php echo getInputValue('username') ?>" name="username" placeholder="Registrar Username" autocomplete="off" required>
 
                        <input type="password" name="password" value="123456" placeholder="Password" autocomplete="off" required>

                        <input type="submit" name="loginButtonRegistrar" value="Login">
                    </form>
                </div>
            </div>
        </div>
