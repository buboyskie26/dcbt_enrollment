<?php 
    ...
    require_once('../../admin/classes/AdminEnrollmentNavigationMenu.php');
    ...
    # TODO.
    // Admin can access registrar in the pages.
    // Registrar cant access admin pages.

    // if (
    //     !isset($_SESSION['adminLoggedIn']) || $_SESSION['adminLoggedIn'] == ''
...
<body>
    ...
    <div id="pageContainer">
        ...
        <!-- <div id="sideNavContainer" style="display: none;"> -->
            <?php
                $nav = new AdminEnrollmentNavigationMenu($con, $adminLoggedInObj);
                echo $nav->create();
            ?>
        </div>
